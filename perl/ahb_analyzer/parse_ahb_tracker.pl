...
#                                       Sicence execution
#                                       Selective logging
#       12  1.04.03     01/10/2019      Corner cases READ ONLY and WRITE ONLY test cases
#                                       have a division of ZERO error, not covered by RANDOM case
#
...
# NOTE:     Differences between Sandbox and XFlow
#           require different considerations for creating logs
#           XFLOW       MOST of the directories are provided
#           Sandbox     ALL  directories and path must be created
...
sub   CreateLoggingPath {
      ...
      printf $proh "\n";
      printf $proh " ... CreateLoggingPath()\n";                                                    # creating subdirectory paths;
      ...
      printf $proh "     CreateLoggingPath() ... done\n";                                           # $filename;
      printf $proh "\n";
